...
| `scope-guard.mjs` | `UserPromptSubmit` | Points at the governing `.claude/rules/*.md` when a prompt touches a sensitive subsystem (viewer safety, roles, realtime, maps, mobile, public API); nudges toward `vtt-task-packet` for multi-file work. | No |
