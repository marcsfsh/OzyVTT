...
export interface ClientToServerEvents {
  ...
  "character:set-inventory": (payload: { commandId: string; actorId: string; item: { id: string; name: string; quantity?: number; equipped?: boolean; attuned?: boolean; weightEach?: number; description?: string }; expectedRevision?: number }, acknowledgement: (result: MutationResult) => void) => void;
