...
describe("public API contracts", () => {
  ...
  it("keeps OpenAPI system paths, versions, scopes, and component references aligned", () => {
    ...
    const expectedPaths = [...Object.values(SYSTEM_PATHS), OPENAPI_DOCUMENT_PATH, ...Object.values(INTEGRATION_CREDENTIAL_PATHS)];
    expect(Object.keys(openApiDocument.paths).sort()).toEqual([...new Set(expectedPaths)].sort());
