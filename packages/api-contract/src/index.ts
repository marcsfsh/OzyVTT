...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      ActorRestRequest: { type: "object", additionalProperties: false, required: ["kind"], properties: { commandId: { type: "string", format: "uuid" }, expectedRevision: { type: "integer", minimum: 0 }, kind: { type: "string", enum: ["long", "short"], description: "short re-arms per-short-rest pools only (hit dice unmodeled — no HP change); long is the full reset" } } },
