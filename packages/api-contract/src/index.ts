 ...
 */
const codexOp = (operationId: string, security: readonly unknown[], okRef: string, options: { ok?: string; params?: readonly unknown[]; body?: string; description?: string; bad?: boolean; notFound?: boolean; conflict?: string; notModified?: boolean } = {}) => ({
  operationId,
  security,
...
export const openApiDocument = {
  ...
  paths: {
    ...
    [CODEX_PATHS.journal]: {
      ...
      post: codexOp("createCodexJournalEntry", codexWrite, "CodexJournalEntryResponse", { ok: "201", body: "CodexJournalWriteRequest", description: "Adds a journal/timeline entry." })
    },
    ...
    [CODEX_PATHS.journalById]: {
      patch: codexOp("updateCodexJournalEntry", codexWrite, "CodexJournalEntryResponse", { body: "CodexJournalWriteRequest", params: [uuidParam("id")], notFound: true, description: "Edits a journal entry." }),
  ...
  components: {
    ...
    schemas: {
      ...
      CodexExportData: { type: "object", additionalProperties: false, required: ["codex", "exportedAt"], properties: { codex: { type: "object", additionalProperties: true, description: "Opaque backup bundle. **Not yet restorable through this API** - there is no import route, and the \"round-trips via the codex import surface\" this field used to claim was aspirational." }, exportedAt: { type: "string", format: "date-time" } } },
