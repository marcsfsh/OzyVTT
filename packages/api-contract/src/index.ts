...
export const openApiDocument = {
  ...
  paths: {
    ...
    [ENCOUNTER_ARCHIVE_PATHS.visibility]: { post: { operationId: "setEncounterArchiveVisibility", security: gameSecurity("combat:write"), description: "Shares (or un-shares) one archived encounter with players (GM sessions and integration credentials only). Hidden by default - an ended fight is the GM's record until the GM says otherwise. This stores the decision; the archive read endpoints are still GM-grade at this version, so sharing does not yet expose a document to a player session.", parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer", minimum: 1 } }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/EncounterArchiveVisibilityRequest" } } } }, responses: { "200": { description: "The stored visibility", content: { "application/json": { schema: { $ref: "#/components/schemas/EncounterArchiveVisibilityResponse" } } } }, "400": apiError, "401": apiError, "403": apiError, "404": apiError } } },
  ...
  components: {
    ...
    schemas: {
      ...
      CodexSession: {
        ...
        required: ["id", "sessionNumber", "realDate", "attendees", "prepBody", "recapBody", "revealedToPlayers", "status", "tags", "rev", "createdAt", "updatedAt"],
        properties: {
          id: codexUuid,
