...
export const openApiDocument = {
  ...
  paths: {
    ...
    [CODEX_PATHS.export]: { get: codexOp("exportCodex", codexGmRead, "CodexExportResponse", { notModified: true, bad: false, description: "A full codex backup bundle for round-trip. Carries whatever revision rows exist, verbatim - the 2026-07-30 revision throttle bounds the WRITES, never this export, and nothing prunes the table, so a backup never lies about how much history it holds." }) },
