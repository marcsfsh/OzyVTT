...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      ContentClassesData: { type: "object", additionalProperties: false, required: ["classes", "attribution"], properties: { classes: { type: "array", items: { type: "object", additionalProperties: false, required: ["id", "name", "source", "summary", "description", "hitDie", "statPriority", "primaryAbilities", "savingThrows", "skillChoiceCount", "skillChoices", "subclassLevel", "subclassLabel", "asiLevels", "spellcastingAbility", "spellcastingProgression", "levelTable", "startingEquipmentOptions", "features"], properties: { id: contentSlug, name: { type: "string" }, source: contentSource, summary: { type: ["string", "null"] }, description: { type: ["string", "null"] }, hitDie: { type: "string", enum: ["d4", "d6", "d8", "d10", "d12"], description: "The multiclass hit-dice pool keys on this" }, statPriority: { ...contentAbilities, description: "All six abilities, best first - the random generator's core input, as data rather than a hardcoded table" }, primaryAbilities: contentAbilities, savingThrows: contentAbilities, skillChoiceCount: { type: "integer", minimum: 0, maximum: 10, description: "How many entries of skillChoices the character picks at level 1" }, skillChoices: { type: "array", items: contentSlug }, subclassLevel: { type: "integer", minimum: 1, maximum: 20 }, subclassLabel: { type: ["string", "null"], description: "What this class calls its subclass (\"Martial Archetype\")" }, asiLevels: { type: "array", items: { type: "integer", minimum: 1, maximum: 20 }, description: "Levels granting an Ability Score Improvement, or a feat instead" }, spellcastingAbility: { type: ["string", "null"], description: "Ability slug for this class's spellcasting; null for a non-caster. Per class, so Paladin CHA + Wizard INT is expressible" }, spellcastingProgression: { type: ["string", "null"], enum: ["full", "half", "third", "pact", null], description: "How this class's levels count toward the shared multiclass caster level" }, levelTable: contentClassLevelTable, startingEquipmentOptions: contentStartingEquipmentOptions, features: contentFeatures } } }, attribution: { type: "string" } } },
