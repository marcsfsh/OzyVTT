...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      CodexSettings: { type: "object", additionalProperties: false, description: "Every codex-WIDE setting as a READER sees it, nested by area, including the read-only usage figures. The `revisionHistory` nesting is what gives a later codex-wide setting a home without inventing fields for it today: `codex_meta` is the codex's singleton settings row, and this is that row as a caller sees it.", required: ["revisionHistory"], properties: { revisionHistory: { $ref: "#/components/schemas/CodexRevisionHistorySettings" } } },
