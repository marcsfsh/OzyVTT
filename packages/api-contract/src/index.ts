...
export const openApiDocument = {
  ...
  paths: {
    ...
    [GAME_PATHS.turnUse]: { post: gameCommandOperation("useTurnSlot", "combat:write", "Marks the current turn's action or bonus action used/unused (tracked, never enforced).", "TurnUseRequest", undefined, true, true) },
    ...
    [GAME_PATHS.actorDamage]: { post: gameCommandOperation("applyDamage", "actor:write", "Applies damage (temporary hit points absorb first). Player sessions may target only their claimed character.", "HpAmountRequest", [uuidParam("actorId")], true, true) },
