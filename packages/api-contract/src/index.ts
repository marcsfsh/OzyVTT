...
export const openApiDocument = {
  ...
  paths: {
    ...
    [CONTENT_PATHS.spells]: { get: contentCatalogOperation("listContentSpells", "The bundled SRD spell list with the fields a sheet needs to cast from: level, school, casting time, range, components, duration, concentration/ritual flags, description, and the upcast (`castingOptions`) rows keyed by slot level. Includes the CC BY 4.0 attribution line.", "ContentSpellsResponse") },
