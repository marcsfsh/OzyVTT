...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      CodexRevealRequest: { type: "object", additionalProperties: false, required: ["revealed"], properties: { revealed: { type: "boolean" } , commandId: { type: "string", format: "uuid", description: "Optional idempotency key: resend the same id to retry safely; the replay carries `x-idempotent-replay: true`." } } },
      CodexFolderPathRequest: { type: "object", additionalProperties: false, required: ["path"], properties: { path: { type: "string", minLength: 1, maxLength: 160 } , commandId: { type: "string", format: "uuid", description: "Optional idempotency key: resend the same id to retry safely; the replay carries `x-idempotent-replay: true`." } } },
      ...
      CodexMapParentRequest: { type: "object", additionalProperties: false, required: ["parentMapId"], properties: { parentMapId: codexNullableUuid , commandId: { type: "string", format: "uuid", description: "Optional idempotency key: resend the same id to retry safely; the replay carries `x-idempotent-replay: true`." } } },
      ...
      CodexMarkerMoveRequest: { type: "object", additionalProperties: false, required: ["x", "y"], properties: { x: codexCoord, y: codexCoord , commandId: { type: "string", format: "uuid", description: "Optional idempotency key: resend the same id to retry safely; the replay carries `x-idempotent-replay: true`." } } },
      ...
      CodexConnectionUpdateRequest: { type: "object", additionalProperties: false, properties: { label: { type: ["string", "null"], maxLength: 40 }, layer: { type: "string", enum: ["player", "gm"] } , commandId: { type: "string", format: "uuid", description: "Optional idempotency key: resend the same id to retry safely; the replay carries `x-idempotent-replay: true`." } } },
