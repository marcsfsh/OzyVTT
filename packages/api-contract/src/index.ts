  ...
  components: {
    ...
    schemas: {
      ...
      CodexChronicleRecord: {
        ...
        required: ["kind", "id", "title", "text", "gmText", "revealedToPlayers", "sessionNumber", "realDate", "inWorldLabel", "calendarInstant", "inWorldDate", "tags", "attachPageId", "attachMarkerId", "sourceEncounterId", "fired", "payload", "proposedDate", "createdAt", "updatedAt"],
        properties: {
          ...
          sessionNumber: { type: ["integer", "null"] },
          ...
          calendarInstant: { type: ["number", "null"], description: "GM-only sort key; not declared on `CodexChronicleRecordPlayer`." },
          inWorldDate: { ...codexInWorldDateOrNull, description: "GM-only raw date; not declared on `CodexChronicleRecordPlayer`." },
