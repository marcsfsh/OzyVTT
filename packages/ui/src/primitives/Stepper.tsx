...
export function Stepper({ value, onChange, min, max, step = 1, label, disabled = false, className, ...aria }: StepperProps) {
  ...
  return (
    <div className={cx("nh-stepper", className)}>
      ...
      <div className="nh-stepper-controls" role="group" aria-label={groupLabel}>
        ...
        <span className="nh-stepper-value tabular" aria-live="polite">{value}</span>
