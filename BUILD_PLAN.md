...
- [~] Limited use, Recharge, Reaction, Bonus Action. (Limited uses with per-turn/encounter/long-rest scopes + shared pools and bonus-action/reaction validation shipped — ADR-0020; Recharge and reaction prompts pending.)
