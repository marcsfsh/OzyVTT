  ...
  router.get(SYSTEM_PATHS.capabilities, async (req, res) => {
    ...
    return res.json({
      ...
      data: {
        ...
        features: { webhooks: false, viewer: true, battlemapGridCalibration: true, gameApi: true, commandTunnel: true, encounterArchives: true, gameEventStream: true, rulesEngine: true }
      }
    });
  });
