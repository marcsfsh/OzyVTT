...
function App() {
  ...
  const leaveGmSession = (notice: string) => { socket.disconnect(); setGmToken(null); setPassword(""); setMode("home"); setState(null); setMessage(notice); };
